...
export const TABLE_REGISTRY_CORE: Record<SyncableTableName, TableMetaCore> = {
  daily_practice_queue: {
    primaryKey: "id",
    uniqueKeys: ["user_ref", "repertoire_ref", "window_start_utc", "tune_ref"],
    timestamps: [
      "queue_date",
      "window_start_utc",
      "window_end_utc",
    ...
    columnDescriptions: {
      ...
      repertoire_ref: "Reference to the repertoire.",
  ...
  note: {
    ...
    columnDescriptions: {
      ...
      repertoire_ref: "Reference to the repertoire (optional).",
  ...
  repertoire: {
    ...
    hasDeletedFlag: true,
    columnDescriptions: {
      deleted: "Soft-delete flag for the repertoire.",
      device_id: "Device that last modified this record.",
      genre_default: "Default genre filter for this repertoire.",
      instrument_ref: "Reference to the instrument for this repertoire.",
      last_modified_at: "Timestamp of last modification.",
      name: "Name of the repertoire.",
      repertoire_id: "Primary key for the repertoire.",
      sr_alg_type: "Spaced repetition algorithm type (SM2/FSRS).",
      sync_version: "Sync version for conflict resolution.",
      user_ref: "User ID who owns this repertoire.",
    },
  },
  repertoire_tune: {
    primaryKey: ["repertoire_ref", "tune_ref"],
    uniqueKeys: ["repertoire_ref", "tune_ref"],
    ...
    columnDescriptions: {
      ...
      deleted: "Soft-delete flag for this repertoire entry.",
      device_id: "Device that last modified this record.",
  ...
  practice_record: {
    primaryKey: "id",
    uniqueKeys: ["tune_ref", "repertoire_ref", "practiced"],
  ...
  tab_group_main_state: {
    ...
    columnDescriptions: {
      ...
      last_modified_at: "Timestamp of last modification.",
      repertoire_id: "Currently selected repertoire.",
  ...
  table_state: {
    primaryKey: ["user_id", "screen_size", "purpose", "repertoire_id"],
    uniqueKeys: ["user_id", "screen_size", "purpose", "repertoire_id"],
    timestamps: ["last_modified_at"],
    booleanColumns: [],
    supportsIncremental: true,
    hasDeletedFlag: false,
    columnDescriptions: {
      ...
      device_id: "Device that last modified this record.",
      last_modified_at: "Timestamp of last modification.",
      repertoire_id: "Reference to the repertoire.",
      purpose:
  ...
  table_transient_data: {
    primaryKey: ["tune_id", "user_id", "repertoire_id"],
    uniqueKeys: ["tune_id", "user_id", "repertoire_id"],
    timestamps: ["practiced", "due", "backup_practiced", "last_modified_at"],
    booleanColumns: [],
    supportsIncremental: true,
    hasDeletedFlag: false,
