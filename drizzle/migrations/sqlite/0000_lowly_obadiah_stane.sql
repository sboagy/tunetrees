...
CREATE INDEX `idx_queue_user_playlist_window` ON `daily_practice_queue` (`user_ref`,`playlist_ref`,`window_start_utc`);--> statement-breakpoint
CREATE INDEX `idx_queue_user_playlist_active` ON `daily_practice_queue` (`user_ref`,`playlist_ref`,`active`);--> statement-breakpoint
CREATE INDEX `idx_queue_user_playlist_bucket` ON `daily_practice_queue` (`user_ref`,`playlist_ref`,`bucket`);--> statement-breakpoint
CREATE INDEX `idx_queue_generated_at` ON `daily_practice_queue` (`generated_at`);--> statement-breakpoint
CREATE UNIQUE INDEX `daily_practice_queue_user_ref_playlist_ref_window_start_utc_tune_ref_unique` ON `daily_practice_queue` (`user_ref`,`playlist_ref`,`window_start_utc`,`tune_ref`);--> statement-breakpoint
CREATE TABLE `genre` (
...
--> statement-breakpoint
CREATE INDEX `idx_instrument_instrument` ON `instrument` (`instrument`);--> statement-breakpoint
CREATE INDEX `idx_instrument_private_to_user` ON `instrument` (`private_to_user`);--> statement-breakpoint
CREATE UNIQUE INDEX `instrument_private_to_user_instrument_unique` ON `instrument` (`private_to_user`,`instrument`);--> statement-breakpoint
CREATE TABLE `note` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`user_ref` integer,
	`tune_ref` integer NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `playlist_user_ref_instrument_ref_unique` ON `playlist` (`user_ref`,`instrument_ref`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_reference_tune_public` ON `reference` (`tune_ref`,`public`);--> statement-breakpoint
CREATE INDEX `idx_reference_tune_user_ref` ON `reference` (`tune_ref`,`user_ref`);--> statement-breakpoint
CREATE INDEX `idx_reference_user_tune_public` ON `reference` (`user_ref`,`tune_ref`,`public`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `idx_tag_user_ref_tag_text` ON `tag` (`user_ref`,`tag_text`);--> statement-breakpoint
CREATE INDEX `idx_tag_user_ref_tune_ref` ON `tag` (`user_ref`,`tune_ref`);--> statement-breakpoint
CREATE UNIQUE INDEX `tag_user_ref_tune_ref_tag_text_unique` ON `tag` (`user_ref`,`tune_ref`,`tag_text`);--> statement-breakpoint
CREATE TABLE `tune` (
	`id` integer PRIMARY KEY AUTOINCREMENT NOT NULL,
	`title` text,
	`type` text,
