-- Return minimal profile fields for members of a visible group.
-- This avoids broadening direct user_profile table visibility while letting
-- the group UI render names/emails for already-visible memberships.
