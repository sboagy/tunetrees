...
CREATE OR REPLACE FUNCTION sync_get_setlist_items(
  p_user_id UUID,
  p_genre_ids TEXT[],
...
AS $$
  ...
  JOIN program p ON p.id = pi.setlist_ref
...
GRANT EXECUTE ON FUNCTION sync_get_setlist_items TO authenticated;