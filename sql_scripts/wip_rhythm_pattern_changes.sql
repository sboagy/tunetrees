-- ============================================================================
-- 1. ALTER EXISTING TABLE: genre_tune_type
-- ============================================================================
...
-- ============================================================================
-- 2. CREATE NEW TABLE: rhythm_patterns
-- ============================================================================
...
CREATE TABLE public.rhythm_patterns (
  ...
  -- Create the composite foreign key back to your linking table
  CONSTRAINT rhythm_patterns_genre_tune_type_fkey 
    FOREIGN KEY (genre_id, tune_type_id) 
    REFERENCES public.genre_tune_type (genre_id, tune_type_id)
    ON DELETE CASCADE
) TABLESPACE pg_default;

-- ============================================================================
-- 3. APPLY ARCHITECTURAL COMMENTS
-- ============================================================================
