                ...
                {(item) => (
                  <label class="flex items-center gap-2 text-sm cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 px-2 py-1.5 rounded">
                    ...
                    <span class="text-gray-900 dark:text-white flex-1">
                      {props.isRepertoire
                        ? getRepertoireDisplayName(item as PlaylistWithSummary)
                        : (item as string)}
                    </span>
...
export const FilterPanel: Component<FilterPanelProps> = (props) => {
  ...
  const totalSelected = () => {
    const repertoireCount = props.hideRepertoireFilter
      ? 0
  ...
  return (
    <div class="relative" ref={panelRef}>
      ...
      <button
        ...
        disabled={props.loading?.genres || props.loading?.repertoires}
          ...
          >
            <div class="space-y-3">
              ...
              <div class="flex items-center gap-2 flex-wrap">
                ...
                <Show when={!props.hideRepertoireFilter}>
                  <FilterDropdown
                    title="Repertoire"
                    ...
                    loading={props.loading?.repertoires}
                    isRepertoire={true}
                  />
                </Show>
              ...
              <Show when={totalSelected() > 0}>
                <div class="flex flex-wrap gap-1">
                  ...
                  {/* Repertoire chips - only shown when repertoire filter not hidden */}
                  <Show when={!props.hideRepertoireFilter}>
