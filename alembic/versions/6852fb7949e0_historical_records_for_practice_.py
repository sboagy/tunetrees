"""historical records for practice, uniqueness constraint for practice_records

Revision ID: 6852fb7949e0
Revises: fa13683caff1
Create Date: 2025-07-19 17:57:11.730730
...
revision: str = '6852fb7949e0'
down_revision: Union[str, Sequence[str], None] = 'fa13683caff1'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('practice_record', schema=None) as batch_op:
        ...
        batch_op.alter_column('stability',
               ...
               type_=sa.Float(),
               existing_nullable=True)
        batch_op.create_index('practice_record_practiced_index', ['practiced'], unique=False)
        batch_op.create_index('practice_record_tune_playlist_practiced_index', ['tune_ref', 'playlist_ref', 'practiced'], unique=False)
        batch_op.create_unique_constraint('practice_record_unique_tune_playlist_practiced', ['tune_ref', 'playlist_ref', 'practiced'])
...
def downgrade() -> None:
    ...
    with op.batch_alter_table('practice_record', schema=None) as batch_op:
        batch_op.drop_constraint('practice_record_unique_tune_playlist_practiced', type_='unique')
        batch_op.drop_index('practice_record_tune_playlist_practiced_index')
        batch_op.drop_index('practice_record_practiced_index')
        batch_op.alter_column('stability',
               existing_type=sa.Float(),
               type_=sa.REAL(),
               existing_nullable=True)
