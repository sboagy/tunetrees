-- Migration: Fix RLS on Readable Views
-- Description: Recreate readable views with security_invoker = true so they respect RLS policies
-- on the underlying tables instead of having unrestricted access.

-- Drop and recreate View 1 with security_invoker
...
-- Drop and recreate View 2 with security_invoker
...
-- Drop and recreate View 3 with security_invoker
