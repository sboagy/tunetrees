...
//   let cookies_list = cookies();
    ...
    return (
      ...
      ></div> */}
            ...
            >
                <div className="flex flex-col justify-center items-center w-66 text-xl ">
                    <p>&nbsp;</p>
                    {/* <p>&nbsp;</p> */}
                    <Image
                        src="/logo.png"
                        ...
                        className="min-w-8"
                    />
                    <div className="flex-3 bg-black h-[16px]"/>
                    <div className="text-4xl font-medium text-white">New User</div>
                    <div className="flex flex-col gap-2 p-6 m-8 w-full bg-transparent rounded shadow-lg">
                            ...
                            >
                                {(provider.id === "credentials" && (
                                    <>
                                        ...
                                        <div className="flex-1 bg-transparent h-[16px]"/>
                                        <label className="text-base font-light text-neutral-800">
                                            {/* Username or Email */}
                                            <input
                                                className="block flex-1 p-3 w-full font-normal rounded-md border border-gray-200 transition sm:text-sm placeholder:font-light placeholder:text-zinc-400 focus:border-zinc-500 focus:ring-zinc-500"
