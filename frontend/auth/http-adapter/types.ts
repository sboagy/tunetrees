...
export type AdapterProcedures<TWithVerificationToken = boolean> =
  DefaultAdapterProcedures &
    (TWithVerificationToken extends true
      ? {
          createVerificationToken: <TRes = unknown>(
            verificationToken: AdapterArg_0<"createVerificationToken">,
          ) => ProcedureConfig<TRes>;
...
export type AdapterManagerConfig<TWithVerificationToken = boolean> = {
  adapterProcedures: AdapterProcedures<TWithVerificationToken>;
} & FetchOptions;
