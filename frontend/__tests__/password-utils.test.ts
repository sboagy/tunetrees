...
describe("Password Validation Utils", () => {
  describe("PASSWORD_REQUIREMENTS", () => {
    ...
    it("should test minimum length requirement", () => {
      const minLengthReq = PASSWORD_REQUIREMENTS.find(
    ...
    it("should test uppercase requirement", () => {
      const uppercaseReq = PASSWORD_REQUIREMENTS.find(
    ...
    it("should test lowercase requirement", () => {
      const lowercaseReq = PASSWORD_REQUIREMENTS.find(
    ...
    it("should test number requirement", () => {
      const numberReq = PASSWORD_REQUIREMENTS.find(
        (req) => req.id === "number",
      );
    ...
    it("should test special character requirement", () => {
      const specialReq = PASSWORD_REQUIREMENTS.find(
        (req) => req.id === "special",
      );
  ...
  describe("calculatePasswordStrength", () => {
    ...
    it("should correctly identify which requirements are met", () => {
      ...
      const requirementsMet = result.requirements
        .filter((req) => req.met)
        .map((req) => req.id);
    ...
    it("should handle edge cases for special characters", () => {
      ...
      for (const char of specialChars) {
        ...
        const specialReq = result.requirements.find(
          (req) => req.id === "special",
        );
